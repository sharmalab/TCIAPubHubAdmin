...
var AddResourcePanel = React.createClass({
  ...
  render: function() {
    ...
    if (selectType == "") {
          ...
          <div>
            {self.state.fileName
              ? <div>
                  ...
                  Added
                  {" "}
                  <strong>{self.state.fileName}</strong>
                  . Drop a file again to overwrite this.
                  {" "}
                </div>
              : <div />}
          </div>
      ...
      ResourceSpecificFields = (
        <div>
          ...
          <input
            type="text"
            value={self.state.shared_list_name}
            onChange={self.handleSharedList}
            className="form-control"
          />
        </div>
      );
      ...
      <div>
        <div className="form-group">
          ...
          <select
            className="form-control"
            id="sel1"
            onChange={self.handleSelectResourceType}
            value={self.state.selectType}
          >
            <option />
            ...
            {self.state.selectType
              ? <div>
                  ...
                  <div className="form-group">
                    ...
                    <textarea
                      value={self.state.resourceDescription}
      ...
      return (
        <li className="list-group-item" key={id}>
          ...
          <div className="row">
            ...
            <span
              className="resourceDelete col-md-1"
              aria-hidden="true"
              onClick={self.deleteResource.bind(self, id)}
    ...
    return (
      <div>
        {resources.length ? <label>Added Resources: </label> : <div />}
    ...
    ver_req
      .end(function(err, res) {
        if (err) {
          ...
          self.setState({
            errorMessage: "Error creating one or more resources",
            error: true
          });
        } else {
      ...
      <div>
        ...
        <div className="container col-md-6 col-offset-3" id="main">
          ...
          <div className="form-group">
            ...
            <a href="index">
              <button className="btn btn-danger" value="Cancel">Cancel</button>
            </a>
          </div>
        </div>
      </div>
